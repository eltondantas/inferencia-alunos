...
a. Responde essas duas perguntas usando testes de hipótese
...
Então, dado que a significância em ambas é de 0,05 (5%), o p-valor de 0,9 obtido na primeira é considerado altíssimo. Isto significa que na veracidade da hipótese nula, os dados da amostra são bastante prováveis. Já na segunda, o p-valor de 0,0012 está muito abaixo da significância. Então, assumindo que a hipótese nula seja verdadeira, os dados da amostra são improváveis.
